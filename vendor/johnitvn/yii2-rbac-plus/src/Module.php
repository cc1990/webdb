...
class Module extends BaseModule {
    ...
    public $userModelChinesenameField = 'chinesename';

    public $userModelDepartmentsField = 'departments';

    public $userModelRolesField = 'roles';
    ...
    public $userModelChinesenameFieldLabel;

    public $userModelDepartmentsFieldLabel;

    public $userModelRolesFieldLabel;
    ...
    public function init() {
        ...
        if ($this->userModelChinesenameFieldLabel == null) {
            $model = new $this->userModelClassName;
            $this->userModelChinesenameFieldLabel = $model->getAttributeLabel($this->userModelChinesenameField);
        }
        if ($this->userModelDepartmentsFieldLabel == null) {
            $model = new $this->userModelClassName;
            $this->userModelDepartmentsFieldLabel = $model->getAttributeLabel($this->userModelDepartmentsField);
        }
        if ($this->userModelRolesFieldLabel == null) {
            $model = new $this->userModelClassName;
            $this->userModelRolesFieldLabel = $model->getAttributeLabel($this->userModelRolesField);
        }
    }
