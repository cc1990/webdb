<?php
    ...
    $this->title = '备份策略组添加';
    $title2 = "<a href='/backup/strategy/index' event-bind='redirect'>备份策略</a>-备份策略组添加";
?>
    <div class="div-index">
    ...
    <div/>
        <form class="sui-form form-horizontal" style="margin-top: 20px">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="name" value="" class="input-xxlarge">
                </div>
            </div>
...
<!--                            <a role="button" data-toggle="dropdown" href="#" class="dropdown-toggle" id="year"><i class="caret"></i><span>*</span></a>-->
...
<!--                      </ul></span></span><label class="date-unit">年</label>-->
        ...
        <div class="part-content">
            ...
            <a href="javascript:void(0);" class="sui-btn btn-block btn-xlarge btn-primary" id="save">添加备份策略组</a>
        </form>
